...
myApp.controllers = {
    ...
    tabbarPage: function(page) {
        ...
        Array.prototype.forEach.call(page.querySelectorAll('[component="button/delete-all"]'), function(element) {
            element.onclick = function() {
                ons.notification.confirm(
                    {
                        title: 'Supprimer toutes les tâches ?',
                        message: 'Les tâches seront supprimées et l\'application sera réinitialisée',
            ...
            element.onclick = function() {
                ...
                if (!localStorage.getItem(newTitle) && newTitle) {
                    ...
                    nouvelleTache = {
                        ...
                        date:page.querySelector('#deadline').value,
    ...
    detailsTaskPage: function(page) {
        ...
        page.querySelector('#deadline').value = element.data.date;
